...
export default function () {
    return (
        <>
            <section className="border-2 mt-[90px] min-h-[400px] h-[500px] w-[100%] bg-[#f0f3f5] flex items-center overflow-hidden ">
                ...
                <div className="border-0 w-[25%] h-[600px] flex relative ">
                    <div className="border-0 space-y-4 w-[300px] ">
                        ...
                        <div className="border-2 w-[220px] h-[230px] rounded-[50px] object-center object-cover overflow-hidden ">
            ...
            <section className="no-scrollbar border-2 w-[100%] min-h-[85vh] bg-[#fafbfb] overflow-hidden  ">
                <div className="border-2 w-full flex justify-between items-center">
                    <h1>Offre de voyage à moin de 500000frs</h1>
                ...
                <div className="no-scrollbar overflow-x-scroll ">
                    <div className="border-2 p-5 min-w-[200%] flex justify-start items-center space-x-3 ">
                        <Cheap
